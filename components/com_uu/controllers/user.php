...
class UuControllerUser extends UuController
{
	...
	public function login()
	{
		...
		if (true === $app->login($credentials, $options)) {
			// Success
            $url = UuSiteHelper::getRedirectUrl($conf->get('red_login_success'),$conf->get('red_login_success_custom'),$conf->get('red_login_success_custom_menu'));
	...
	public function logout()
	{
		...
		if (!($error instanceof Exception)) {
            ...
            $return = UuSiteHelper::getRedirectUrl($conf->get('red_logout_success'),$conf->get('red_logout_success_custom'),$conf->get('red_logout_success_custom_menu'));
