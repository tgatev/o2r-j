...
//             jexit();
    ...
    public function upNms() {
        $this->upAjax("INSERT IGNORE INTO ofrs_ad_network_monitor(user_id,ad_network_id) VALUES (@u,@i)");
    }
    
    public function upNmr() {
        $this->upAjax("DELETE FROM ofrs_ad_network_monitor WHERE user_id = @u AND ad_network_id = @i");
    }
