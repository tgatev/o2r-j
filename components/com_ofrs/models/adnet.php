	...
	public function getItem($pk = null)
	{
		...
		if (!isset($this->_item[$pk]))
		{
			try
			{
				...
				$query->join('LEFT OUTER', ($db->quoteName('ofrs_payout_type', 'e')) . ' ON (' . $db->quoteName('c.payout_type') . ' = ' . $db->quoteName('e.id') . ')');
