...
<form action="<?php echo JRoute::_('index.php?option=com_ofrs&view=adnets'); ?>" method="post" id="adminForm">
    ...
    <div class="row pagination-content">
        ...
        <article class="row Rtable-row vertical-center-sm" id="<?= $id ;?>">
            <section class="col-xs-12 col-sm-8 col-md-3 col-no-gutters vertical-center-sm">
                <div><?= OfrsHelper::getNetworkBoxButtonLayout($item->adnet_id, $item->adnet_name, $item->adnet_display_properties); ?> </div>
            </section>
            <section class="hidden-xs hidden-sm col-md-7 adnet-description col-no-gutters vertical-center-sm">
