...
class OfrsViewOffer extends JViewLegacy
{
	...
	protected function _prepareDocument()
	{
		...
		$this->document->addStyleSheet(JURI::root(true) .'/components/com_ofrs/assets/css/offer.css', (OfrsHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css');
	}
