...
<div><b>'.$text.'</b></div>';
    ...
    static function getNetworkBoxButtonLayout($id, $adnet_name, $styles = array(), $class = "offer-network-box" ){
        // for test reasons Mok Json data to simulate input :
//         if(!$styles or count($styles)) $styles = OfrsHelper::parseDisplayProperties(OfrsHelper::mokNetworksBoxButtonColorsJson(), 'NetworkBoxButtonColors');
