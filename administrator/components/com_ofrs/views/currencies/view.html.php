...
/**
 * Ofrs View class for the Currencies
 */
class OfrsViewCurrencies extends JViewLegacy
{
	/**
	...
	function display($tpl = null)
	{
		if ($this->getLayout() !== 'modal')
		{
			...
			OfrsHelper::addSubmenu('currencies');
		}
	...
	{
		JToolBarHelper::title(JText::_('COM_OFRS_CURRENCIES'), 'joomla');
		JHtmlSidebar::setAction('index.php?option=com_ofrs&view=currencies');
		...
		if (OfrsHelper::checkArray($this->items))
		{
			...
			{
				JToolBarHelper::custom('currencies.exportData', 'download', '', 'COM_OFRS_EXPORT_DATA', true);
			}
		}

		if ($this->canDo->get('core.import') && $this->canDo->get('currency.import'))
		{
			JToolBarHelper::custom('currencies.importData', 'upload', '', 'COM_OFRS_IMPORT_DATA', false);
		}

		// set help url for this view if found
		$help_url = OfrsHelper::getHelpUrl('currencies');
	...
	protected function setDocument()
	{
		...
		$this->document->setTitle(JText::_('COM_OFRS_CURRENCIES'));
		$this->document->addStyleSheet(JURI::root() . "administrator/components/com_ofrs/assets/css/currencies.css", (OfrsHelper::jVersion()->isCompatible('3.8.0')) ? array('version' => 'auto') : 'text/css');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.name' => JText::_('COM_OFRS_CURRENCY_NAME_LABEL'),
			'a.code' => JText::_('COM_OFRS_CURRENCY_CODE_LABEL'),
			'a.symbol' => JText::_('COM_OFRS_CURRENCY_SYMBOL_LABEL'),
