...
if ($this->saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_ofrs&task=currencies.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_ofrs&view=currencies'); ?>" method="post" name="adminForm" id="adminForm">
...
<?php else : ?>
        ...
        <?php if ($this->canCreate && $this->canEdit) : ?>
            <?php echo JHtml::_(
                ...
                'collapseModal',
                array(
                    'title' => JText::_('COM_OFRS_CURRENCIES_BATCH_OPTIONS'),
