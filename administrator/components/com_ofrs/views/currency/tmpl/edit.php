...
<div class="form-horizontal">
	...
	<?php echo JHtml::_('bootstrap.addTab', 'currencyTab', 'details', JText::_('COM_OFRS_CURRENCY_DETAILS', true)); ?>
	...
	<?php echo JHtml::_('bootstrap.addTab', 'currencyTab', 'publishing', JText::_('COM_OFRS_CURRENCY_PUBLISHING', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
	...
	<?php echo JHtml::_('bootstrap.addTab', 'currencyTab', 'permissions', JText::_('COM_OFRS_CURRENCY_PERMISSION', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
