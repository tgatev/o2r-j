...
<div class="form-horizontal">
	...
	<?php echo JHtml::_('bootstrap.addTab', 'countryTab', 'details', JText::_('COM_OFRS_COUNTRY_DETAILS', true)); ?>
	...
	<?php echo JHtml::_('bootstrap.addTab', 'countryTab', 'publishing', JText::_('COM_OFRS_COUNTRY_PUBLISHING', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
	...
	<?php echo JHtml::_('bootstrap.addTab', 'countryTab', 'permissions', JText::_('COM_OFRS_COUNTRY_PERMISSION', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
