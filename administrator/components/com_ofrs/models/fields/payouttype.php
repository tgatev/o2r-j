...
/**
 * Payouttype Form Field class for the Ofrs component
 */
class JFormFieldPayouttype extends JFormFieldList
{
	/**
	 * The payouttype field type.
	 *
	 * @var		string
	 */
	...
	protected function getOptions()
	{
		...
		if ($items)
		{
			...
			{
				$options[] = JHtml::_('select.option', $item->id, $item->payout_type_name);
			}
		}
		return $options;
	}
