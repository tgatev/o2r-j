 ...
 */
class OfrsModelCurrency_exchange_rates extends JModelList
{
	...
	protected function getListQuery()
	{
		...
		$query->from($db->quoteName('#__ofrs_currency_exchange_rate', 'a'));
	...
	public function getExportData($pks)
	{
		...
		if (OfrsHelper::checkArray($pks))
		{
			...
			// From the ofrs_currency_exchange_rate table
			$query->from($db->quoteName('#__ofrs_currency_exchange_rate', 'a'));
	...
	*/
	public function getExImPortHeaders()
	{
		...
		$db = JFactory::getDbo();
		// get the columns
		$columns = $db->getTableColumns("#__ofrs_currency_exchange_rate");
	...
	protected function checkInNow()
	{
		...
		if ($time)
		{
			...
			$query = $db->getQuery(true);
			$query->select('*');
			$query->from($db->quoteName('#__ofrs_currency_exchange_rate'));
			$db->setQuery($query);
			$db->execute();
			if ($db->getNumRows())
			{
				...
				// Check table
				$query->update($db->quoteName('#__ofrs_currency_exchange_rate'))->set($fields)->where($conditions); 
