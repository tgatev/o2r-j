 ...
 */
class OfrsModelPayment_methods extends JModelList
{
	...
	public function getExportData($pks)
	{
		...
		if (OfrsHelper::checkArray($pks))
		{
			...
			// From the ofrs_payment_method table
			$query->from($db->quoteName('#__ofrs_payment_method', 'a'));
	...
	*/
	...
	protected function checkInNow()
	{
		...
		if ($time)
		{
			...
			$query = $db->getQuery(true);
			$query->select('*');
			$query->from($db->quoteName('#__ofrs_payment_method'));
			$db->setQuery($query);
			$db->execute();
			if ($db->getNumRows())
			{
				...
				// Check table
				$query->update($db->quoteName('#__ofrs_payment_method'))->set($fields)->where($conditions); 
