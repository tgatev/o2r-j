...
/**
 * Tracking_platforms Model
 */
class OfrsModelTracking_platforms extends JModelList
{
	...
	protected function checkInNow()
	{
		...
		if ($time)
		{
			...
			if ($db->getNumRows())
			{
				...
				// Check table
				$query->update($db->quoteName('#__ofrs_tracking_platform'))->set($fields)->where($conditions); 
