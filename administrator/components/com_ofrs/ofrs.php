...
// Access check.
if (!JFactory::getUser()->authorise('core.manage', 'com_ofrs'))
{
...
$document->addStyleSheet('components/com_ofrs/assets/css/admin.css');
$document->addScript('components/com_ofrs/assets/js/admin.js');
