...
/**
 * General Controller of Ofrs component
 */
class OfrsController extends JControllerLegacy
{
	...
	function display($cachable = false, $urlparams = false)
	{
		...
		$view   = $this->input->getCmd('view', 'ofrs');
		...
		{
			if ($data['edit'] && $layout == 'edit' && !$this->checkEditId('com_ofrs.edit.'.$data['view'], $id))
			{
				...
				else
				{
					...
					$this->setRedirect(JRoute::_('index.php?option=com_ofrs&view='.$data['views'], false));
				}
	...
	protected function getViewRelation($view)
	{
		...
		if (OfrsHelper::checkString($view))
		{
			...
			$views = array(
				'imp_session' => 'imp_sessions',
				'imp_request' => 'imp_requests',
				'imp_offer' => 'imp_offers',
				'imp_message' => 'imp_messages',
				'offer' => 'offers',
				'country' => 'countries',
				'vertical' => 'verticals',
				'currency' => 'currencies',
				'tracking_platform' => 'tracking_platforms',
				'ad_network' => 'ad_networks',
				'phrase_offer' => 'phrase_offers',
				'phrase_vertical' => 'phrase_verticals',
				'phrase' => 'phrases',
				'offer_payout' => 'offer_payouts',
