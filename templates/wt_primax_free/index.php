...
<!--        Eye Icon -->
<!--        <link rel="apple-touch-icon" sizes="72x72" href="/images/fav-eye/apple-touch-icon.png">-->
<!--        <link rel="icon" type="image/png" sizes="32x32" href="/images/fav-eye/favicon-32x32.png">-->
<!--        <link rel="icon" type="image/png" sizes="16x16" href="/images/fav-eye/favicon-16x16.png">-->
<!--        <link rel="manifest" href="/images/fav-eye/site.webmanifest">-->
<!--        <link rel="mask-icon" href="/images/fav-eye/safari-pinned-tab.svg" color="#5bbad5">-->
...
<!--        <meta name="theme-color" content="#ffffff">-->
                ...
                <?php
                $megabgcolor = ($this->helix3->PresetParam('_megabg')) ? $this->helix3->PresetParam('_megabg') : '#f5f5f5';
                $megabgtx = ($this->helix3->PresetParam('_megatx')) ? $this->helix3->PresetParam('_megatx') : '#707070';

                $preloader_bg = ($this->helix3->getParam('preloader_bg')) ? $this->helix3->getParam('preloader_bg') : '#a96d01';
                $preloader_tx = ($this->helix3->getParam('preloader_tx')) ? $this->helix3->getParam('preloader_tx') : '#ffffff';
