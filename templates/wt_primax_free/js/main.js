...
jQuery(function ($) {
    ...
    // Select Menu Items;
    // jQuery('#sp-menu ul.sp-megamenu-parent a.topbar-hover-background');
    // jQuery('a[data-route]');
    //
    ...
    // }
    // xmlhttp.send();
    // let session_adnet_filter = <?php echo '' ?>
    //
    // let url = new URL(window.location.href);
    // let searchParams = new URLSearchParams(url.search);
    // let has_view = searchParams.has("view");
    // let has_filter = searchParams.has("view");
    // alert(has_filter + ','+ has_view ); // true
    // console.log(url);
    // console.log(searchParams);

    // Has no view and filter ( pages like /)
    // if(!(has_view || has_filter) ){
    //
    // }
    //Default
