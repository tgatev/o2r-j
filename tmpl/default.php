...
<!--            <input type="text" name="filter[search]" id="filter_search" placeholder="Search offers"-->
<!--                   value="--><?//= $search_filters_data['search']?? "" ?><!--"-->
<!--                   class="col-xs-12"-->
<!--                   onfocus="this.placeholder = ''"-->
<!--                   onblur="this.placeholder = 'Search offers'"-->
<!--                   onmouseover="this.placeholder = ''"-->
<!--                   onmouseleave="this.placeholder = 'Search offers'"-->
<!--                   onkeypress="triggerSearch(event);"-->
<!--            >-->
